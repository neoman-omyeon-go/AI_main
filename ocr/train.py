...
if __name__ == '__main__':
    ...
    parser.add_argument('--character', type=str,
                        default='0123456789abcdefghijklmnopqrstuvwxyz가각간갇갈'
    ...
    train(opt)
# python train.py --train_data data_lmdb_release/training --valid_data data_lmdb_release/validation --select_data MJ-ST --batch_ratio 0.5-0.5  --Transformation None --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction CTC
#  python train.py --train_data data_lmdb/train_lmd --valid_data data_lmdb/valid_lmd --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction Attn
